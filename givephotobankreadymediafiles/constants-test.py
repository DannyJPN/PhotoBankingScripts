...
TEST_CATEGORIES_CSV: str = (
    "F:/Dropbox/Scripts/Python/Fotobanking/givephotobankreadymediafiles/tests/data/test_categories.csv"
)
...
# Test categories
TEST_CATEGORIES: list[str] = ["Test_Nature", "Test_People", "Test_Technology"]
