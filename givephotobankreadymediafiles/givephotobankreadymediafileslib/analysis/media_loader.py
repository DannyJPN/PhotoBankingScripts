...
from givephotobankreadymediafileslib.constants import IMAGE_EXTENSIONS, VECTOR_EXTENSIONS, VIDEO_EXTENSIONS
...
class MediaLoader:
    ...
    def load_image(self, file_path: str) -> tuple[np.ndarray | None, dict[str, Any]]:
        """
    ...
    def load_video(self, file_path: str, sample_rate: int = 1) -> tuple[list | None, dict[str, Any]]:
        """
    ...
    def load_vector(self, file_path: str) -> tuple[np.ndarray | None, dict[str, Any]]:
        """
