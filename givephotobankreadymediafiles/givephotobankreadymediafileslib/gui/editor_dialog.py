...
class ProcessingThread(QThread):
    ...
    def __init__(self, orchestrator: MediaOrchestrator, file_path: str):
        """
...
class EditorDialog(QDialog):
    ...
    def __init__(
        ...
        self.metadata_generator = MetadataGenerator(
            categories_file=categories_file, training_data_dir=training_data_dir
        )
        ...
        self.orchestrator = MediaOrchestrator(
            ...
            models_dir=os.path.join(os.path.dirname(training_data_dir), "models") if training_data_dir else "",
    ...
    def initUI(self):
        ...
        for client in self.available_llm_clients:
            self.llm_combo.addItem(client["name"], {"type": client["type"], "model_id": client["model_id"]})
    ...
    def save_metadata(self):
        ...
        if self.training_data_dir:
            ...
            analysis = {"metadata": {"file_path": self.file_path, "file_name": os.path.basename(self.file_path)}}
