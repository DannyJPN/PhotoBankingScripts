...
class MetadataGenerator:
    ...
    def _load_categories(self) -> dict[str, list[str]]:
        ...
        try:
            with open(self.categories_file, encoding="utf-8-sig", newline="") as csvfile:
    ...
    def save_training_data(self, file_path: str, analysis: dict[str, Any], metadata: dict[str, Any]) -> bool:
        ...
        try:
            ...
            training_data = {"file_path": file_path, "timestamp": timestamp, "analysis": analysis, "metadata": metadata}
