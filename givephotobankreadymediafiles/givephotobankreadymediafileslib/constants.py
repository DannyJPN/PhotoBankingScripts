...
COCO_CATEGORIES_URL = "https://raw.githubusercontent.com/ultralytics/ultralytics/main/ultralytics/cfg/datasets/coco.yaml"
...
TITLE_JSON_STRUCTURE = {
    "title": "string"  # The generated title, max 80 characters
}

DESCRIPTION_JSON_STRUCTURE = {
    "description": "string"  # The generated description, max 200 characters
}

KEYWORDS_JSON_STRUCTURE = {
    "keywords": ["string"]  # List of 10-20 keywords as strings
}

CATEGORY_JSON_STRUCTURE = {
    "category": "string"  # The selected category name from the provided list
}
